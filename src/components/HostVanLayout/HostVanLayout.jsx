      ...
      <>
        <div className="hostvanlayout--card">
          ...
          <div className="hostvanlayout--van-data">
            ...
            <p className="hostvanlayout--van-price">${van.price}<span className="hostvanlayout--van-price-day">/day</span></p>
          </div>
        </div>
        <nav className="host--nav-main">
          <div className="host--nav-items">
            <NavLink end className={({isActive})=> isActive ? "activeLink" : "host--nav-item"} to="">Details</NavLink>
            <NavLink className={({isActive})=> isActive ? "activeLink" : "host--nav-item"} to="pricing">Pricing</NavLink>
            <NavLink className={({isActive})=> isActive ? "activeLink" : "host--nav-item"} to="photos">Photos</NavLink>            
          </div>
          <Outlet />
      </nav>
      </>
